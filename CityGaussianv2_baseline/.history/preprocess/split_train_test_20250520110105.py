...
if __name__ == '__main__':
    ...
    copyimage(traindata, '/mnt/data/yangchengcity/slgy_s5_baitian/images', 'data/train/')
    copyimage(testdata, '/mnt/data/yangchengcity/slgy_s5_baitian/images', 'data/test/')
