...
COARSE_NAME=citygsv2_ysz_coarse_sh2
NAME=citygsv2_ysz_sh2_trim
PROJECT=ysz_normallight  # Change to your project name
gpu_id=0,1
scan_dir=data/yangchengcity/normal_light/yushanzhen
