...
def main():
    ...
    source_folder = "/mnt/data/yangchengcity/diffusion_reflection/kunshanzhongxue/images/"   # 源图像文件夹路径
    destination_folder = "/mnt/data/yangchengcity/diffusion_reflection/kunshanzhongxue/partitons-dim_3_3_visibility_0.05/000_000/"  # 目标文件夹路径
