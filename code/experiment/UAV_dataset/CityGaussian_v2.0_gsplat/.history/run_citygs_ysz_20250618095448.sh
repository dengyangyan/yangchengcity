...
COARSE_NAME=citygsv2_kszxs3_coarse_sh2
NAME=citygsv2_kszxs3_sh2_trim
PROJECT=kszxs3_normallight_vggt  # Change to your project name
gpu_id=0,1
scan_dir=/mnt/data/yangchengcity/diffusion_reflection/kunshanzhongxue
...
#                                     --config configs/yangchengcity/$COARSE_NAME.yaml \
#                                     -n $COARSE_NAME \
#                                     --logger wandb \
#                                     --project $PROJECT \
...
gpu_id=$(get_available_gpu)
echo "GPU $gpu_id is available."
# CUDA_VISIBLE_DEVICES=$gpu_id python utils/partition_citygs.py --config_path configs/yangchengcity/$NAME.yaml --force  # --reorient
...
# echo "GPU $gpu_id is available."
CUDA_VISIBLE_DEVICES=$gpu_id python main.py test \
                                    --config outputs/citygsv2_kszxs3_sh2_trim/blocks/block_7/config.yaml \
                                    -n $NAME \
...
# configs/yangchengcity/$NAME.yaml
