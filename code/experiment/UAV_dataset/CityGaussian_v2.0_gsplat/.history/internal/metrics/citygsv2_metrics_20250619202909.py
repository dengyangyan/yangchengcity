...
class CityGSV2MetricsModule(GS2DMetricsImpl):
    ...
    def get_train_metrics(self, pl_module, gaussian_model, step: int, batch, outputs) -> Tuple[Dict[str, Any], Dict[str, bool]]:
        ...
        #有阴影
        if batch[1][0] == "DJI_20250108093841_1888_V.JPG":
            with open("DJI_20250108093841_1888_V.txt", "a") as f:
                f.write(f"{metrics['ssim']},{metrics['rgb_diff']},{metrics['dist_loss']},{metrics['normal_loss']},{metrics['extra_loss']},{metrics['loss']}, {metrics['d_reg']},{metrics['d_w']}\n")  
        if batch[1][0] == "DJI_20250108093602_1618_V.JPG":
            with open("DJI_20250108093602_1618_V.txt", "a") as f:
                f.write(f"{metrics['ssim']},{metrics['rgb_diff']},{metrics['dist_loss']},{metrics['normal_loss']},{metrics['extra_loss']},{metrics['loss']}, {metrics['d_reg']},{metrics['d_w']}\n")  
        if batch[1][0] == "DJI_20250108093601_1615_V.JPG":
