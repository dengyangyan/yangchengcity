...
from internal.optimizers import OptimizerConfig, Adam, SelectiveAdam, SparseGaussianAdam, MUON
...
class OptimizationConfig:
    ...
    optimizer: OptimizerConfig = field(default_factory=lambda: {"class_path": "MUON"})
