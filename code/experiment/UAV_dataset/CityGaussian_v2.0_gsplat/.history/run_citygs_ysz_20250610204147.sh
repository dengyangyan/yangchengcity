...
PROJECT=kszxs3_normallight  # Change to your project name
gpu_id=0,1
scan_dir=/mnt/data/yangchengcity/normal_light/kunshanzhongxues3
...
# echo "GPU $gpu_id is available."
CUDA_VISIBLE_DEVICES=$gpu_id python main.py test \
                                    --config outputs/citygsv2_kszxs3_sh2_trim/blocks/block_7_0.001/config.yaml \
                                    -n $NAME \
