...
parser.add_argument("dataset_dir")#, type=str, default='/mnt/data/yangchengcity/slgy_s5_baitian/'
...
if args.depth_dir is None:
    args.depth_dir = os.path.join(args.dataset_dir, "estimated_depths_vggt")
if args.output is None:
    args.output = os.path.join(args.dataset_dir, "estimated_depth_scales.json")

sparse_model_dir = os.path.join(args.dataset_dir, "triangulated_e3")
