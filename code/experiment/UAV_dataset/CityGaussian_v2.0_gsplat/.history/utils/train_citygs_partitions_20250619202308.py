...
def train_a_partition(
    ...
    # basic
    args = [
        "/home/dengyangyan/anaconda3/envs/gspl/bin/python",
        "main.py", "fit",
        "--config", config_file,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_name", "-n", type=str, required="citygsv2_kszxDR_sh2_trim")
    parser.add_argument("--config_dir", "-c", type=str, default="./configs/yangchengcity")
    parser.add_argument("--project_name", "-p", type=str, required="kszxs3_DR")
